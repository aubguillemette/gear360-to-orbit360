...
if (-not $input_file) {
    Write-Host "Usage: gear360-to-pixpro.ps1 -input_file <input_file> [-output_file <output_file>] [-metadata_dir_path <metadata_dir_path>] [-ffmpeg_path <ffmpeg_path>] [-mp4edit_path <mp4edit_path>]"
    exit 1
}
